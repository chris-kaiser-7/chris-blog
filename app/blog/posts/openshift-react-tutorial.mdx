...
for example from [heatmat.git](https://github.com/chris-kaiser-7/appname)
```
.
├── Dockerfile
├── README.md
...
appname   appname-myproject.apps.gaspar.ontampa.dev          appname    8080-tcp   edge          None
```
And you should be able to navigate to https://yourhost/yourpath (eg. https://appname-myproject.apps.gaspar.ontampa.dev) here and see your application!
